...
for env in "${strings[@]}"; do
    echo "$env"
    ## PPO Experiments
    # sbatch --array=1-3 --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000' --time=47:59:00 launchGPU.sh ## Normal PPO
    # sbatch --array=1-3 --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --old_wrapers ' --time=47:59:00 launchGPU.sh ## Normal PPO
    ...
    ## DQN Experiments
    # sbatch --array=1-3 --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000' --time=47:59:00 launchGPU.sh ## Normal
    sbatch --array=1-3 --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --old_wrapers ' --time=47:59:00 launchGPU.sh ## Normal PPO
    ...
    ## PQN Experiments
    # sbatch --array=1-3 --export=ALL,ALG='cleanrl/pqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000' --time=47:59:00 launchGPU.sh ## Normal
    ...
    # sbatch --array=1-3 --export=ALL,ALG='cleanrl/rainbow_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 25000000' --time=47:59:00 launchGPU.sh ## Normal
