...
#     # sbatch --array=1-4 --export=ALL,ALG='cleanrl/pqn.py',ENV_ID=$env,INTRINSIC_REWARDS='--intrinsic_rewards E3B',ARGSS='--total_timesteps 25000000 --num_envs 4 --intrinsic_reward_scale=0.2' launch.sh
