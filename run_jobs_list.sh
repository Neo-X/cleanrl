...
for env in "${strings[@]}"; do
    ...
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --old_wrapers ' --time=11:59:00 launchGPU.sh ## Normal PPO
    ...
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --old_wrapers ' --time=11:59:00 launchGPU.sh ## Normal PPO
