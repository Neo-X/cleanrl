...
### Standard experiments
    ...
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/ppo.py',ENV_ID=$env,ARGSS='--track --total_timesteps 25000000 --num_envs 4 --no_norm_adv' launch.sh
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/ppo.py',ENV_ID=$env,ARGSS='--track --total_timesteps 25000000 --num_envs 4 --no_norm_adv --zero_positive_advantages' launch.sh
...
#     sbatch --array=1-4 --export=ALL,ALG='cleanrl/ppo_continuous_action.py',ENV_ID=$env,ARGSS='--num_layers=16 --use_layer_norm --num_envs 4 --total_timesteps 5000000' launch.sh
    ...
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/sac_continuous_action.py',ENV_ID=$env,ARGSS='--num_layers=8 --num_envs 4 --total_timesteps 2000000' launch.sh
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/sac_continuous_action.py',ENV_ID=$env,ARGSS='--num_layers=16 --num_envs 4 --total_timesteps 2000000' launch.sh
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/sac_continuous_action.py',ENV_ID=$env,ARGSS='--num_layers=32 --num_envs 4 --total_timesteps 2000000' launch.sh
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/sac_continuous_action.py',ENV_ID=$env,ARGSS='--num_layers=64 --num_envs 4 --total_timesteps 2000000' launch.sh
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/sac_continuous_action.py',ENV_ID=$env,ARGSS='--num_layers=128 --num_envs 4 --total_timesteps 2000000' launch.sh
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/sac_continuous_action.py',ENV_ID=$env,ARGSS='--num_layers=256 --num_envs 4 --total_timesteps 2000000' launch.sh
done
...
for env in "${strings[@]}"; do
    echo "$env"
    ## PPO Experiments
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000' --time=47:59:00 launchGPU.sh ## Normal PPO
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --old_wrappers' --time=47:59:00 launchGPU.sh ## Normal PPO
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --intrinsic_rewards RND --intrinsic_reward_scale=0.2' --time=47:59:00 launchGPU.sh ## PPO with RND
    ...
    ## DQN Experiments
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000' --time=47:59:00 launchGPU.sh ## Normal
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --old_wrappers' --time=47:59:00 launchGPU.sh ## Normal PPO
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --intrinsic_rewards RND --intrinsic_reward_scale=0.2' --time=47:59:00 launchGPU.sh ## with RND
    ...
    ## PQN Experiments
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/pqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000' --time=47:59:00 launchGPU.sh ## Normal
    # sbatch --array=1-5 --export=ALL,ALG='cleanrl/pqn_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 50000000 --intrinsic_rewards RND --intrinsic_reward_scale=0.2' --time=47:59:00 launchGPU.sh ## with RND
    ...
    sbatch --array=1-5 --export=ALL,ALG='cleanrl/rainbow_atari.py',ENV_ID=$env,ARGSS='--total_timesteps 25000000' --time=167:59:00 launchGPU.sh ## Normal
